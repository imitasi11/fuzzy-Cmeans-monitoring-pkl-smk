    ...
    <div id="content">
     <table border="1">
      ...
      <?php for ($i=1; $i <=count($random_uik) ; $i++) { 
        echo "<tr>";
        $konklusi = array_search(max($random_uik[$i]),$random_uik[$i]);?>

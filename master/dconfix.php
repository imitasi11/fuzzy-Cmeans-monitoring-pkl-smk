...
$query_datapesan = sprintf("SELECT * FROM konfix WHERE iterasi LIKE %s", GetSQLValueString("%" . $colname_datapesan . "%", "text"));
...
<div id="page">
			...
			<div style="clear: both;">&nbsp;
              <table border="1" align="center">
                <tr align="Left">
                  <td width="5"><strong>Iterasi</strong></td>
                  <td width="50"><strong>Bobot</strong></td>
                  <td width="50"><strong>Epsilon</strong></td>
				...
				<tr align="center">
                    ...
                    <td width="33"><a href="editkonfix.php?no=<?php echo $row['Kode']; ?>" ><img src="images/edit.gif" alt="" width="58" height="20" /></a></td>
                    <td width="32"><a href="deletekonfix.php?no=<?php echo $row['Kode']; ?>"><img src="images/delete.gif" alt="" width="58" height="20" /></a></td>
                  </tr>
                  <?php }  ?>
              </table>
            </div>

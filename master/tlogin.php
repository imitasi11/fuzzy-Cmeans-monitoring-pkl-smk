...
$query_pesan = sprintf("SELECT * FROM tbusers ");
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbusers (username, pass, level) VALUES ( %s, %s, %s)",
  ...
  mysql_select_db($database_RON, $RON);
$query_Nomorbeli = "SELECT username FROM tbusers ORDER BY username DESC";
...
<li id="menu-item-1248" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1248" style="z-index: 100;"><a href="">Data User</a>
<ul class="sub-menu" style="display: none; top: 45px; visibility: visible;">
	<li id="menu-item-1348" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1348"><a href="tlogin.php">Tambah Data User</a></li>
	<li id="menu-item-1247" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1247"><a href="dlogin.php">View Data User</a></li>
</ul>
</li>
...
<div class="inner">
  <div id="content2">
    <div class="post">
      <h2 class="title"><a href="#">Input Data User</a></h2>
      <hr />
    ...
    <div class="post">
      <form action="<?php echo $editFormAction; ?>" method="post" id="form1">
        <table>
              ...
              <td><input type="text" name="nama" value="" size="15" /></td>
            </tr>
			            <tr valign="baseline">
              <td align="left">Level User:</td>
              ...
              <td><input type="text" name="passw" value="" size="10" /></td>
            </tr>
                      <tr valign="baseline">
              <td align="right">&nbsp;</td>

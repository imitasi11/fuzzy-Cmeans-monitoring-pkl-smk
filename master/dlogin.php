...
$query_datapesan = sprintf("SELECT * FROM tbusers WHERE username LIKE %s", GetSQLValueString("%" . $colname_datapesan . "%", "text"));
    ...
    <div id="primary" class="content-area">
      ...
      <div class="container">
        <div class="pub-info" itemprop="text">
          <!-- Section: intro -->
          <div id="page">
            <h2 class="title"><a href="#">Data User</a></h2>
            <hr />
            <div style="clear: both;">&nbsp;
                <table border="1" align="center">
                  ...
                  <?php
					...
					$kd_bahan = 0;
					$modal=mysqli_query($mysqli,"SELECT * FROM tbusers");
                  ...
                  <tr align="center">
                    ...
                    <td width="32"><a href="deleteuser.php?no=<?php echo $row['username']; ?>"><img src="images/delete.gif" alt="" width="58" height="20" /></a></td>
                  </tr>
                  <?php }  ?>
                </table>
            </div>

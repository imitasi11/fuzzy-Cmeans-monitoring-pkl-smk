...
if ((isset($_GET['no'])) && ($_GET['no'] != "")) {
  ...
  $deleteSQL = sprintf("DELETE FROM random",
...
<div id="page">
	<div id="content">
	  <div class="post">
		<h2 class="title"><a href="#">Pengolahan Nilai Random Fuzzy C Means</a></h2>
        <hr />
    </div>

    				  <table width="1000" border="2" align="center">
				<thead>
				  <th width="5" bordercolor="#000000"><div align="center">ID_Proses</th>
					<th width="5" bordercolor="#000000"><div align="center">NIS</th>
						<th width="100" bordercolor="#000000"><div align="center">C1</th>
						<th width="100" bordercolor="#000000"><div align="center">C2</th>
						<th width="100" bordercolor="#000000"><div align="center">C3</th>
					</thead>
				...
				$Cx3=1-($Cx1+$Cx2);
					...
					<tr bordercolor="#000000">
					  <td><center><?php echo $kd_bahan; ?></center></td>
					  <td><center><?php echo $kd_1; ?></center></td>
					  <td><center><?php echo $Cx1; ?></center></td>
					  <td><center><?php echo $Cx2; ?></center></td>					  
				  	  <td><center><?php echo $Cx3; ?></center></td>					  
				  </tr>
					...
					require_once('Connections/RON.php');
					  ...
					  $insertSQL = sprintf("INSERT INTO random (nis, Nama, C1, C2, C3) VALUES (%s, %s, %s, %s, %s)",                       
					   GetSQLValueString($kd_1, "text"),
					   GetSQLValueString($nm_1, "text"),
					   GetSQLValueString($Cx1, "double"),
					   GetSQLValueString($Cx2, "double"),
					   GetSQLValueString($Cx3, "double"));

	...
	<div id="content">
	  <div class="post">
        ...
        <hr />
				...
				<thead>
				  <th width="5" bordercolor="#000000"><div align="center">No_Distribusi</th>
					<th width="5" bordercolor="#000000"><div align="center">Nama</th>
				...
				$Cx3=1/10;
					...
					require_once('Connections/RON.php');
					  ...
					  $insertSQL = sprintf("INSERT INTO random (nik, Nama, C1, C2, C3) VALUES (%s, %s, %s, %s, %s)",                       
					   GetSQLValueString($kd_11, "text"),
					   GetSQLValueString($NM_11, "text"),

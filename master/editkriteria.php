...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbtesting SET nis=%s, nama=%s, absensi=%s, tugas=%s WHERE idtesting=%s",
                       GetSQLValueString($_POST['nis'], "int"),
			   		   GetSQLValueString($_POST['nama'], "text"),
					   GetSQLValueString($_POST['absensi'], "int"),
					   GetSQLValueString($_POST['tugas'], "int"),
					   GetSQLValueString($_POST['kdbrg'], "int"));

  mysql_select_db($database_RON, $RON);
  $Result1 = mysql_query($updateSQL, $RON) or die(mysql_error());

  $updateGoTo = "dkriteria.php?nama=&submit=cari";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_RON, $RON);
$query_Recordset1 = sprintf("SELECT * FROM tbtesting WHERE idtesting = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<div class="inner">	
	<div id="title_box"><a href="https://smkn2solo.sch.id/"><img src="./SMK Negeri 2 Surakarta_files/logo-Web-SMKN-2-Surakarta2.png" alt="Logo" id="logo" style="opacity: 1;"></a></div>
...
<div class="clear"></div>
	...
	<div id="content">
		<div class="post">
			<h2 class="title"><a href="#">Edit Data Kriteria</a></h2>
			<hr />
              ...
              <form action="<?php echo $editFormAction; ?>" method="post" id="form1">
                <table align="center">
                  <tr valign="baseline">
                    ...
                    <td><input type="text" name="kdbrg" value="<?php echo $row_Recordset1['idtesting']; ?>" size="32" readonly="readonly"/></td>
                  </tr>
            		<tr valign="baseline">
                    <td align="right">NIS:</td>
                    <td><input type="text" name="nis" value="<?php echo $row_Recordset1['nis']; ?>" size="32" readonly="readonly"/></td>
                  </tr>
            		<tr valign="baseline">
                    <td align="right">Nama:</td>
                    <td><input type="int" name="nama" value="<?php echo $row_Recordset1['nama']; ?>" size="32" /></td>
                  </tr>
                  <tr valign="baseline">
                    <td align="right">Absensi:</td>
                    <td><input type="int" name="absensi" value="<?php echo $row_Recordset1['absensi']; ?>" size="32" /></td>
                  </tr>
                  <tr valign="baseline">
                    <td align="right">Tugas:</td>
                    <td><input type="int" name="tugas" value="<?php echo $row_Recordset1['tugas']; ?>" size="32" /></td>
                  </tr>
                  <tr valign="baseline">
                    <td align="right">&nbsp;</td>
                ...
                <input type="hidden" name="kdb" value="<?php echo $row_Recordset1['idtesting']; ?>" />
				 </form>
              <p>&nbsp;</p>
			</div>
	  </div>

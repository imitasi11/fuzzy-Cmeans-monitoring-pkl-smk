...
$query_pesan = sprintf("SELECT * FROM tbusers ", GetSQLValueString($colname_pesan, "int"));
        ...
        <form action="<?php echo $editFormAction; ?>" method="post" id="form1">
          <table>
		    <tr valign="baseline">
              ...
              <td><input type="text" name="user_r" value="" size="15" /></td>
            </tr>
			<tr valign="baseline">
              <td align="right">Password:</td>
              <td><input type="password" name="jual_r" value="" size="8" /></td>
            </tr>
			<tr valign="baseline">
              <td align="right">&nbsp;</td>
              <td><input type="submit" name="simpan" value="OK" />

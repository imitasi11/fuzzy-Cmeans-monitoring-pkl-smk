...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE daftar SET  nama=%s, namadudi=%s, Jeniskelamin=%s, alamatdudi=%s, jurusan=%s, kelas=%s WHERE NIS=%s",
  ...
  $updateGoTo = "dsiswa.php?nama=&submit=cari";
  if (isset($_SERVER['QUERY_STRING'])) {
...
//var_dump($colname_Recordset1);die;
mysql_select_db($database_RON, $RON);
$query_Recordset1 = sprintf("SELECT * FROM daftar WHERE NIS = %s", GetSQLValueString($colname_Recordset1, "char"));
$Recordset1 = mysql_query($query_Recordset1, $RON) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
//var_dump($query_Recordset1);die;
?>
<!DOCTYPE html>
...
<select><option selected="selected" value="">Go to...</option><option value="index.php">Beranda</option><option value="penulis.php">Tentang Penulis</option><option value="fuzzy.php">Proses Fuzzy</option><option value="perhitungan.php">Monitoring C-Means</option></select></div></div>
...
<div class="inner">
  <div id="primary2" class="content-area">
	...
	<div id="content">
		<div class="post">
			<h2 class="title"><a href="#">Edit Data Siswa</a></h2>
			<hr />
              ...
              <form action="<?php echo $editFormAction; ?>" method="post" id="form1">
                <table align="center">
                  <tr valign="baseline">
                    ...
                    <td><input type="text" name="NIS" value="<?php echo $row_Recordset1['NIS']; ?>" size="32" readonly/></td>
                  </tr>
                  <tr valign="baseline">
              		<td align="right">NISN:</td>
              		<td><input name="nisn" type="text" value="<?php echo ($row_Recordset1['NISN']); ?>" size="32" readonly/></td>
            		</tr>
					                    <tr valign="baseline">
                      <td align="right">Nama:</td>
                      <td><input type="text" name="nama" value="<?php echo ($row_Recordset1['nama']); ?>" size="30" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td align="right">Nama DUDI:</td>
                      <td><input name="namadudi" type="text" value="<?php echo ($row_Recordset1['namadudi']); ?>" size="50"  /></td>
                    </tr>
                    <tr valign="baseline">
                  <td align="right">Jenis Kelamin:</td>
                  <td><input name="jk" type="text" value="<?php echo ($row_Recordset1['Jeniskelamin']); ?>" size="50"  /></td></tr>
                  <tr valign="baseline">
                  <td align="right">Alamat DUDI:</td>
                  <td><input name="alamatdudi" type="text" value="<?php echo ($row_Recordset1['alamatdudi']); ?>" size="50" /></td>
                  </tr>
                   <tr valign="baseline">
              <td align="right">Jurusan:</td>
              <td><input name="jurusan" type="text" value="<?php echo ($row_Recordset1['jurusan']); ?>" size="30"  /></td>
            </tr>
					<tr valign="baseline">
                  <td align="right">Kelas:</td>
                  <td><input type="text" name="kelas" value="<?php echo ($row_Recordset1['kelas']); ?>" size="15"/></td>
                  </tr>
				<tr valign="baseline">
                    <td align="right">&nbsp;</td>
                ...
                <input type="hidden" name="kdb" value="<?php echo $row_Recordset1['No_B']; ?>" />
				 </form>
              <p>&nbsp;</p>
			</div>
	  </div>
...
<script async type="text/javascript" src="Manfaat%20dan%20Risiko%20Memakai%20Kawat%20Gigi%20%E2%80%A2%20Hello%20Sehat_files/outbrain.js"></script>

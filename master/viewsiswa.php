...
$query_datapesan = sprintf("SELECT * FROM distributor WHERE Kode LIKE %s", GetSQLValueString("%" . $colname_datapesan . "%", "text"));
...
<div id="page">
			<h2 class="title"><a href="#">Data Distributor</a></h2><hr />
			<div style="clear: both;">&nbsp;
              <table border="1" align="center">
                <tr align="Left">
                  <td width="5"><strong>No Distributor</strong></td>
                  <td width="50"><strong>Nama</strong></td>
                  <td width="50"><strong>Alamat</strong></td>
                  <td width="100"><strong>No Identitas</strong></td>
                  <td width="50"><strong>Telepon</strong></td>
                  <td width="100"><strong>Tanggal</strong></td>
                </tr>
                	<?php
					include "/connections/ron.php";
					$kd_bahan = 0;
					$modal=mysqli_query($mysqli,"SELECT * FROM distributor");

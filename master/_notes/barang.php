...
$query_pesan = sprintf("SELECT * FROM barang WHERE No_B = %s", GetSQLValueString($colname_pesan, "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO barang (Kode_Barang, Nama_Barang, Satuan, Jenis, Area_P, minjual) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['kdbrg'], "text"),
					   GetSQLValueString($_POST['nama'], "int"),
                       GetSQLValueString($_POST['sat'], "text"),
					   GetSQLValueString($_POST['jenis'], "int"),
                       GetSQLValueString($_POST['area'], "text"),
					   GetSQLValueString($_POST['minp'], "int"));
    ...
    <section id="intro" class="intro">
		<div class="intro-content">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
			<h2 class="title"><a href="#">Form Data Barang</a></h2>
            <hr />
	  ...
	  <div class="post">
        <form action="<?php echo $editFormAction; ?>" method="post" id="form1">
          <table>
		    <tr valign="baseline">
              <td align="right">Kode Brang:</td>
              <td><input type="text" name="kdbrg" value="" size="15" /></td>
            </tr>
			<tr valign="baseline">
			...
			<tr valign="baseline">
              ...
              <td><input type="int" name="sat" value="" size="10" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">Jenis:</td>
              <td><input type="int" name="jenis" value="" size="30" /></td>
			  </tr>
            <tr valign="baseline">
			...
			<tr valign="baseline">
              ...
              <td><input type="text" name="minp" value="" size="25" /></td>
            </tr>
			<tr valign="baseline">
              <td align="right">&nbsp;</td>

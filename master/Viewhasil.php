...
<div id="page">
	<div id="content">
	  <div class="post">
		<h2 class="title"><a href="#">HASIL PERHITUNGAN C-MEANS</a></h2>
        <hr />
    </div>
            	...
            	<table id="example" class="table table-bordered table-striped">
					...
					$modal=mysqli_query($mysqli,"SELECT * FROM Random ");
					while($row=mysqli_fetch_array($modal)){
					$no_tran++;
					$kd_11=$row['No_Dist'];
					$NM_11=$row['Nama'];
					...
					$jh5=$jh2+$jh5;										
					$jh6=$jh3+$jh6;										
					$modal2=mysqli_query($mysqli,"SELECT * FROM distribusi WHERE No_Dist LIKE '%$kd_11%'");
					while($rows=mysqli_fetch_array($modal2)){
					$jt1=$jh1*$rows['Jumlah'];
					$jt2=$jh1*$rows['Penjualan'];
					$jt3=$jh2*$rows['Jumlah'];
					$jt4=$jh2*$rows['Penjualan'];
					$jt5=$jh3*$rows['Jumlah'];
					$jt6=$jh3*$rows['Penjualan'];
					$jt7=$jh1*$rows['Frekuensi'];
					$jt8=$jh2*$rows['Frekuensi'];
					$jt9=$jh2*$rows['Frekuensi'];
					$jumlah=$jumlah+$jt1;
					$jumlah1=$jumlah1+$jt2;
					$jumlah2=$jumlah2+$jt3;
					$jumlah3=$jumlah3+$jt4;
					...
					$Ca1=(pow(($jumlah-$rows['Jumlah']),2))+(pow(($jumlah1-$rows['Penjualan']),2))+(pow(($jumlah6-$rows['Frekuensi']),2));
					$Ca2=(pow(($jumlah2-$rows['Jumlah']),2))+(pow(($jumlah3-$rows['Penjualan']),2))+(pow(($jumlah7-$rows['Frekuensi']),2));
					$Ca3=(pow(($jumlah4-$rows['Jumlah']),2))+(pow(($jumlah5-$rows['Penjualan']),2))+(pow(($jumlah8-$rows['Frekuensi']),2));
					?>
					<?php } 
					}
					?>
					...
					<tr>
						...
						<td><center><?php echo $Ca7; ?></center></td>						
						<td><center><?php echo $Ca8; ?></center></td>
						<td><center><?php echo $Ca9; ?></center></td>                        
						<td><center><?php echo $Ca7+$Ca8+$Ca9; ?></center></td>                        
